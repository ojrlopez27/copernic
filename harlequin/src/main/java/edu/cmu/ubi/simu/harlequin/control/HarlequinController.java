...
public class HarlequinController implements Runnable, VisualizerObserver {
    ...
    /***
     * Constructor is private since HarlequinController uses the singleton pattern
     */
    ...
    *****************************************************************************************************/
    ...
    /**
     * HarlequinController runs two main processes:
    ...
    public void start(){
        try {
            initMUF();
            initComposition();
            CommonUtils.execute( this ); // here we call the HarlequinController.run() method
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    *****************************************************************************************************/
    ...
    /**
     * This is the main thread where HarlequinController is executed. We add a delay (FREQUENCY_BN_PLOT) so
    ...
    *****************************************************************************************************/
     ...
     * HarlequinController (after some delay) by invoking the action callback
     * @param action
     */
