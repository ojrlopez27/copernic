...
package de.nec.nle.siafu.simulation.glasgow;

import static de.nec.nle.siafu.simulation.glasgow.Constants.ACQUISITIVELEVEL_TYPES;
import static de.nec.nle.siafu.simulation.glasgow.Constants.CUISINE_TYPES;
import static de.nec.nle.siafu.simulation.glasgow.Constants.GENDER_TYPES;
import static de.nec.nle.siafu.simulation.glasgow.Constants.MUSICGENDER_TYPES;
import static de.nec.nle.siafu.simulation.glasgow.Constants.WORKAREA_TYPES;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.ACQUISITIVELEVEL;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.ACTIVITY;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.AGE;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.CUISINE;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.GENDER;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.MUSICGENDER;
import static de.nec.nle.siafu.simulation.glasgow.Constants.Fields.WORKAREA;

import java.util.ArrayList;
import java.util.Random;

import de.nec.nle.siafu.exceptions.PlaceNotFoundException;
import de.nec.nle.siafu.simulation.glasgow.Constants.Activity;
