...
import de.nec.nle.siafu.simulation.valencia.AgentGenerator;
import de.nec.nle.siafu.simulation.valencia.AgentModel;
import de.nec.nle.siafu.simulation.valencia.ContextModel;
...
public final class Siafu {
	...
	public static void main(final String[] args) {
		...
		String scenario = "glasgow";
		String simulationPath = "/Users/oscarr/Desktop/Siafu/scenarios/" + scenario + "/";
		...
		try {		
			for (String className : new String[]{"AgentModel", "ContextModel", "WorldModel"}) {
				map.put(className, Class.forName( String.format("de.nec.nle.siafu.simulation.%s.%s", scenario, className) ));
			}
		}catch (Exception e){
			e.printStackTrace();
		}
		new Controller(configPath, simulationPath, map);
	}
}
