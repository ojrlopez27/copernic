...
public abstract class SimulationData {
	 ...
	 */
	public static SimulationData getInstance(final String pathString, HashMap<String, Class> map) {
		...
		if( map != null && !map.isEmpty() ){
			return new MapSimulationData(givenPath, map);
		}else {
