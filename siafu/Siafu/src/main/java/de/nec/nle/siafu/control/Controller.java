...
public class Controller {
	 ...
	 */
	public Controller(final String configPath, final String simulationPath, HashMap<String, Class> map) {
		...
		if (guiUsed) {
			...
			gui = new GUI(this, simulationPath, map);
			...
			simulation = new Simulation(simulationPath, this, map);
		} else {
	 ...
	 *            simulation.
	 */
	public void startSimulation(final String simulationPath, HashMap<String, Class> map) {
		simulation = new Simulation(simulationPath, this, map);
	}
